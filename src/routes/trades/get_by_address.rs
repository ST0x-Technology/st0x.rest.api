...
pub async fn get_trades_by_address(
    ...
    _shared_raindex: &State<crate::raindex::SharedRaindexProvider>,
    span: TracingSpan,
    ...
    async move {
        ...
        tracing::warn!("get_trades_by_address is not implemented in this branch");
        Err(ApiError::Internal(
            "get_trades_by_address is not implemented".into(),
        ))
    }
    .instrument(span.0)
    .await
